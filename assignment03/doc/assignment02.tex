...
\begin{homeworkProblem}
    ...
    In terms of advantages, the new scheme is quite scalable. If you want a more
    reliable system, you can increase the ratio of n to m. In other words, you
    can allow for significantly more faults because you only need m copies of a
    file to reconstruct that file. Meanwhile, you have to option to reduce the
    ratio of n to m for the sake of speed. 
